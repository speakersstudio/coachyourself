...
var ImprovisersComponent = (function () {
    function ImprovisersComponent(_app, router, http) {
        this._app = _app;
        this.router = router;
        this.http = http;
        this.contact = {
    ...
    ImprovisersComponent.prototype.ngOnInit = function () {
        this.setupSize();
    };
    ImprovisersComponent.prototype.setupSize = function () {
    };
    ImprovisersComponent.prototype.login = function () {
        this._app.login();
    };
    ImprovisersComponent.prototype.showContactDialog = function () {
        this.contactDialogVisible = true;
        this._app.backdrop(true);
    };
    ImprovisersComponent.prototype.hideContactDialog = function () {
        this.contactDialogVisible = false;
        this.sent = false;
        this.sending = false;
        this._app.backdrop(false);
    };
    ImprovisersComponent.prototype.submitContact = function () {
        var _this = this;
