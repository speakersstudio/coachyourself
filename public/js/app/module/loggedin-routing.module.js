...
var LoggedInRoutingModule = (function () {
    function LoggedInRoutingModule() {
    }
    LoggedInRoutingModule = __decorate([
        core_1.NgModule({
            imports: [router_1.RouterModule.forChild(routes)],
            exports: [router_1.RouterModule]
        })
    ], LoggedInRoutingModule);
    return LoggedInRoutingModule;
}());
exports.LoggedInRoutingModule = LoggedInRoutingModule;
;

//# sourceMappingURL=loggedin-routing.module.js.map
